      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <h2 className="text-4xl md:text-6xl font-bold font-['Syne'] mb-6">
            Genera tu estrategia viral a pelo
          </h2>
          <p className="text-gray-400 text-lg mb-8 max-w-md">
            ¿No sabes por dónde empezar? Usa nuestra herramienta interna de IA para generar un fragmento de estrategia de contenido rápido para tu marca.
          </p>

          <form onSubmit={handleGenerate} className="space-y-4 max-w-md">
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">Nombre de la Marca</label>
              <input 
                type="text" 
                value={brand}
                onChange={(e) => setBrand(e.target.value)}
                placeholder="ej. Café Urbano"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">Industria / Nicho</label>
              <input 
                type="text" 
                value={industry}
                ...
                {loading ? (
                    <div className="flex-1 flex flex-col items-center justify-center relative z-10 animate-in fade-in duration-300">
                        ...
                        <div className="space-y-4 w-full max-w-xs text-center">
                             ...
                             <p className="text-gray-500 text-xs font-medium tracking-widest pt-4 uppercase animate-pulse">Conectando con Gemini AI...</p>
                        </div>
                    </div>
                ) : result ? (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 relative z-10">
                        <div>
                            <p className="text-xs text-purple-400 font-bold uppercase tracking-widest mb-2">Bio del Perfil</p>
                            <h3 className="text-2xl font-bold leading-tight">"{result.headline}"</h3>
                        </div>

                        <div>
                            <p className="text-xs text-blue-400 font-bold uppercase tracking-widest mb-3">Ganchos Virales</p>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center text-gray-600 space-y-4 relative z-10">
                        ...
                        <p>Ingresa los detalles de tu marca para desbloquear insights de IA.</p>
                    </div>
                )}
            </div>
