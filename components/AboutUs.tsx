      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light mx-auto">
              <div dangerouslySetInnerHTML={{__html: t(
                'about.main_text',
                'En RNT Studio ayudamos a marcas, negocios y creadores a comunicar con claridad e intención, construyendo presencias digitales con identidad y crecimiento real.<br/>No hacemos contenido por hacer: desarrollamos estrategias que ordenan, diferencian y potencian desde adentro hacia afuera.<br/>Creemos que comunicar es encontrar una voz, una estética y una estrategia que trabajen juntas. Las marcas crecen cuando lo que dicen coincide con lo que son, y por eso diseñamos contenido y estrategias que se sienten, se ven y funcionan.'
              )}} />
            </div>

            {/* Right Card - Visual */}
            <div className="flex items-center justify-center relative overflow-hidden min-h-[500px]">
              <div className="relative w-[300px] h-[550px] bg-[#2A2A2A] rounded-[3rem] border-8 border-[#2A2A2A] shadow-2xl">
