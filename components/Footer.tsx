      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-8 pt-2">
            {/* Column 1 */}
            <div>
              <h3 className="font-bold mb-6 text-sm uppercase tracking-wider text-white">Navegar</h3>
            ...
            {/* Column 3 */}
            <div>
              <h3 className="font-bold mb-6 text-sm uppercase tracking-wider text-white">Info</h3>
              <ul className="space-y-4 text-gray-400 font-medium">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 mt-20 border-t border-white/10 text-sm text-gray-500 font-medium">
          <p>© 2024 RNT Studio.</p>
          <p className="mt-2 md:mt-0 opacity-60">Diseñado en Buenos Aires</p>
        </div>
      </div>
    </footer>
  );
